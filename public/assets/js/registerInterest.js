window.cfields = {
  ...
  289: "ips_book_your_stand_specialization",
  290: "ips_book_your_stand_specializationother",
  6: "message",
  370: "ips_award_sponsorship_type",
  235: "ips_interests",
  348: "how_did_you_hear_about_us",
  240: "ips_catalogue",
  241: "ips_post_show_report",
  242: "ips_book_your_stand",
  328: "mainsource",
  329: "subsource",
  38: "forms_submitted",
};
...
window._show_pc_confirmation = function (id, header, detail, show, email) {
  ...
  hideButton.addEventListener("click", function () {
    var submitButton = document.querySelector("#_form_400_submit");
  ...
  script.onerror = function () {
    if (isSubmit) {
      if (script.src.length > 10000) {
        ...
        _show_error("400", "Sorry, your submission failed. Please try again.");
      }
      submitButton.disabled = false;
      submitButton.classList.remove("processing");
    }
...
(function () {
  ...
  var _removed = false;
  var form_to_submit = document.getElementById("_form_400_");
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      var interest = $('input[name="field[235][]"]:checked')
        .map(function () {
          return $(this).val();
        })
        .get();
      ...
      var sponsorship_type = $('select[name="field[370]"]').val();
